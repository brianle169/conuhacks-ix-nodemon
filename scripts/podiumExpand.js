...
function updateScores() {
  ...
  scores.forEach((item) => {
    ...
    listItem.innerHTML = `<table class="score-data">
            <tr>
                <td>${item.name}</td>
...
function expandPodium() {
  let iframe = document.getElementById("podium");
  console.log(iframe);
  let questionPanelElement =
    iframe.contentDocument.querySelector(".js-question-panel");
  //   let questionPanelElement = document.querySelector(".js-question-panel");
  // parent.window.document.querySelector(".question-panel");
  console.log(questionPanelElement);
  // parent.window.document.querySelector(".js-question-panel");
